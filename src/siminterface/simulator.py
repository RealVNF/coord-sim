...
class Simulator:
    ...
    def network_metrics(self):
        ...
        self.network_stats = {
            ...
            'avg_end2end_delay_of_dropped_flows': stats['avg_end2end_delay_of_dropped_flows'],
            'avg_end2end_delay_of_processed_flows': stats['avg_end2end_delay_of_processed_flows'],
            'avg_sf_processing_delay': stats['avg_sf_processing_delay'],
